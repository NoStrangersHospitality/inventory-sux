        ...
        {view === 'hub' && (
          <>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '24px' }}>
              <div>
                <h1 style={{ fontSize: '20px', fontWeight: '500', color: '#000' }}>BOH Count</h1>
                <p style={{ color: '#999', fontSize: '13px', marginTop: '4px' }}>Start a new kitchen inventory count or review past counts.</p>
              </div>
        ...
        {view === 'setup' && (
          <>
            <div style={{ marginBottom: '24px' }}>
              <h1 style={{ fontSize: '20px', fontWeight: '500', color: '#000' }}>New BOH Count</h1>
          ...
          <>
            <div style={{ background: '#fff', border: '1px solid #e8e8e8', borderRadius: '12px', padding: '14px 18px', marginBottom: '16px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                <div style={{ fontSize: '13px', fontWeight: '500', color: '#000' }}>BOH Count in Progress — {activeSession.count_date}</div>
            ...
            <div style={{ background: '#fff', border: '1px solid #e8e8e8', borderRadius: '12px', overflow: 'hidden', marginBottom: '16px' }}>
              {visibleLines.length === 0 ? (
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                  <thead>
                    <tr>
                      {['Item', 'Type', 'Unit', 'Par', 'Count'].map((h, i) => (
            ...
            <div style={{ background: '#fff', border: '1px solid #e8e8e8', borderRadius: '12px', padding: '16px 18px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div style={{ fontSize: '13px', color: '#aaa' }}>
                {progressPct < 100 ? `${100 - progressPct}% of items still at zero` : '✓ All items counted'}
              </div>
        ...
        {view === 'review' && reviewSession && (
          <>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '20px' }}>
              <div>
                <h1 style={{ fontSize: '20px', fontWeight: '500', color: '#000' }}>BOH Count — {reviewSession.count_date}</h1>
