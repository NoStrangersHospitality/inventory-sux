            ...
            <div style="padding:40px 32px;">
              ...
              <div style="background:#f5f5f3;border-radius:12px;padding:24px;margin-bottom:28px;">
                ...
                <div style="display:flex;align-items:flex-start;margin-bottom:14px;">
                  <div style="width:24px;height:24px;background:#F5B800;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:700;color:#000;flex-shrink:0;margin-right:12px;text-align:center;line-height:24px;">1</div>
                  <div>
                ...
                <div style="display:flex;align-items:flex-start;margin-bottom:14px;">
                  <div style="width:24px;height:24px;background:#F5B800;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:700;color:#000;flex-shrink:0;margin-right:12px;text-align:center;line-height:24px;">2</div>
                  <div>
                ...
                <div style="display:flex;align-items:flex-start;">
                  <div style="width:24px;height:24px;background:#F5B800;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:700;color:#000;flex-shrink:0;margin-right:12px;text-align:center;line-height:24px;">3</div>
                  <div>
