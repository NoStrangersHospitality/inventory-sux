      ...
      <div style={{ width: '100%', maxWidth: '400px' }}>
        ...
        <div style={cardStyle}>
          ...
          /* FORGOT PASSWORD — FORM */
            ...
            <>
              <h2 style={{ fontSize: '18px', fontWeight: '500', color: '#000', marginBottom: '8px' }}>Reset your password</h2>
              ...
              <form onSubmit={handleReset}>
                ...
                <button type="submit" disabled={resetLoading} style={{ width: '100%', background: resetLoading ? '#ccc' : '#333', color: '#fff', border: 'none', borderRadius: '8px', padding: '12px', fontSize: '14px', fontWeight: '700', cursor: resetLoading ? 'not-allowed' : 'pointer' }}>
          ...
          /* NORMAL LOGIN */
            ...
            <>
              <h2 style={{ fontSize: '18px', fontWeight: '500', color: '#000', marginBottom: '24px' }}>Sign in</h2>
              <form onSubmit={handleLogin}>
                ...
                <button type="submit" disabled={loading} style={{ width: '100%', background: loading ? '#ccc' : '#333', color: '#fff', border: 'none', borderRadius: '8px', padding: '12px', fontSize: '14px', fontWeight: '700', cursor: loading ? 'not-allowed' : 'pointer' }}>
